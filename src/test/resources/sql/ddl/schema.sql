...
(
     ...
     COMPANY          VARCHAR(45)     NULL,  --      COMMENT  수신 업체명 , 
     INCHARGE         VARCHAR(45)     NULL,  --      COMMENT  수신 담당자 이름 , 
     TEL              VARCHAR(45)     NULL,  --      COMMENT  수신 전화번호 , 
     EMAIL            VARCHAR(45)     NULL,  --      COMMENT  수신 이메일 , 
     SPID_ID          INT             NULL,  --      COMMENT  발신인 아이디 , 
