<template>
    <div id="header">
        <div id="gnb">
            <li><router-link to="/solution1">솔루션 1팀</router-link></li>
            <li><router-link to="/solution2">솔루션 2팀</router-link></li>
            <li><router-link to="/admin/sender">발신자 관리</router-link></li>
